      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-2.5 rounded-2xl border px-4 py-2.5 text-[17px] font-bold transition-all ${
              active
          ...
          >
            ...
            <span
              className={`inline-flex min-w-[30px] items-center justify-center rounded-full px-2.5 py-1 text-[13px] font-black leading-none ${
