...
export const PERMISSIONS = {
  ...
  canApproveDelivery: (role: Role) => ['manager'].includes(role),
  canDeleteDelivery: (role: Role) => ['manager'].includes(role),
  canApproveReconciliation: (role: Role) => ['manager'].includes(role),
  canApproveInvoice: (role: Role) => ['manager'].includes(role),
  canApproveGoodsReceipt: (role: Role) => ['manager'].includes(role),
  ...
  canApproveStockAdjustment: (role: Role) => ['manager'].includes(role),
