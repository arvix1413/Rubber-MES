export const SHARED_PRINT_ITEM_TABLE_CSS = `
  ...
  table.items .col-amt{width:10%;white-space:nowrap !important;overflow-wrap:normal !important;word-break:keep-all !important;font-size:10px;font-variant-numeric:tabular-nums}
